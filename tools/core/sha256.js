// SHA-256 (FIPS 180-4) of a string's UTF-8 bytes, in plain synchronous
// JavaScript, so manifest digests are computed the same way in Node and in
// browsers. Tests check it against node:crypto.
