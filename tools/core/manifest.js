...
export function computeDigest(manifest) {
  return `sha256:${sha256Hex(canonicalJSON({ ...manifest, digest: null }))}`;
}
...
// `schema` is the manifest JSON Schema; `vocabulary` is plain vocabulary data
// or an already-indexed vocabulary.
export function validateManifest(manifest, { schema, vocabulary }) {
